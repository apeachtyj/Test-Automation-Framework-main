...
class OperationConfig:
    ...
    def get_section_swagger_url(self):
        """获取 Swagger JSON 地址"""
        return self.get_section_for_data("SWAGGER", "url")

    def get_section_swagger_dir(self):
        """获取自动生成用例的存放目录"""
        return self.get_section_for_data("SWAGGER", "output_dir")
