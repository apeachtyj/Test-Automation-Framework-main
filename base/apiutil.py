...
class RequestBase:
    ...
    def specification_yaml(self, base_info, test_case):
        ...
        try:
            ...
            if base_info['url'].startswith('http'):
                url = base_info['url']
            else:
                url = url_host + base_info['url']
            ...
            validation = self.parse_validation(test_case.pop('validation'))
            # 处理参数提取
            ...
            try:
                ...
                # 如果解析 JSON 失败，记录日志但不让整个程序直接语法报错
                logs.error(f"响应解析或断言失败: {e}")
                raise e
            ...
            for key, value in testcase_extarct.items():
                ...
                for pat in pattern_lst:
                    if pat in value:
                        ...
                        GlobalContext.set_vars(extract_data)
                ...
                if '$' in value:
                    ...
                    GlobalContext.set_vars(extarct_data)
            ...
            for key, value in testcase_extract_list.items():
                if "(.+?)" in value or "(.*?)" in value:
                    ...
                    if ext_list:
                        ...
                        GlobalContext.set_vars(extract_date)
